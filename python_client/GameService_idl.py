...
class _objref_GameService (CORBA.Object):
    ...
    def playerReadyForFirstRound(self, *args):
        return self._obj.invoke("playerReadyForFirstRound", _0_GameModule.GameService._d_playerReadyForFirstRound, args)
