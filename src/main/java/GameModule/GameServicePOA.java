 ...
 implements GameModule.GameServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("cleanupPlayerSession", new java.lang.Integer (25));
    _methods.put ("addWord", new java.lang.Integer (26));
    _methods.put ("updateWord", new java.lang.Integer (27));
    _methods.put ("deleteWord", new java.lang.Integer (28));
    _methods.put ("getAllWords", new java.lang.Integer (29));
    _methods.put ("getSystemStatistics", new java.lang.Integer (30));
    _methods.put ("getLeaderboardEntries", new java.lang.Integer (31));
    _methods.put ("startMultiplayerGame", new java.lang.Integer (32));
    _methods.put ("getMultiplayerLobbyState", new java.lang.Integer (33));
    _methods.put ("sendMultiplayerGuess", new java.lang.Integer (34));
    _methods.put ("startMultiplayerNextRound", new java.lang.Integer (35));
    _methods.put ("getMatchHistory", new java.lang.Integer (36));
    _methods.put ("getMatchDetails", new java.lang.Integer (37));
  }
  ...
  // Explicit cleanup after game session ends
       case 25:  // GameModule/GameService/cleanupPlayerSession
       {
         String username = in.read_string ();
  ...
  // Admin word management
       case 26:  // GameModule/GameService/addWord
       {
       ...
       case 27:  // GameModule/GameService/updateWord
       {
       ...
       case 28:  // GameModule/GameService/deleteWord
       {
         String word = in.read_string ();
         boolean $result = false;
       ...
       case 29:  // GameModule/GameService/getAllWords
       {
         String $result[] = null;
       ...
       case 30:  // GameModule/GameService/getSystemStatistics
       {
  ...
  // Multiplayer mode
       case 32:  // GameModule/GameService/startMultiplayerGame
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 33:  // GameModule/GameService/getMultiplayerLobbyState
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 34:  // GameModule/GameService/sendMultiplayerGuess
       {
         String username = in.read_string ();
         char letter = in.read_char ();
         boolean $result = false;
       ...
       case 35:  // GameModule/GameService/startMultiplayerNextRound
       {
         String username = in.read_string ();
         boolean $result = false;
  ...
  // Match history (returns JSON)
       case 36:  // GameModule/GameService/getMatchHistory
       {
         String username = in.read_string ();
         String $result = null;
  ...
  // JSON array of GameSummary
       case 37:  // GameModule/GameService/getMatchDetails
       {
