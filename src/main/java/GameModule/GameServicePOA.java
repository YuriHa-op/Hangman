 ...
 implements GameModule.GameServiceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getGameSessionResult", new java.lang.Integer (24));
    _methods.put ("getGameState", new java.lang.Integer (25));
    _methods.put ("cleanupPlayerSession", new java.lang.Integer (26));
    _methods.put ("addWord", new java.lang.Integer (27));
    _methods.put ("updateWord", new java.lang.Integer (28));
    _methods.put ("deleteWord", new java.lang.Integer (29));
    _methods.put ("getAllWords", new java.lang.Integer (30));
    _methods.put ("getSystemStatistics", new java.lang.Integer (31));
    _methods.put ("getLeaderboardEntries", new java.lang.Integer (32));
    _methods.put ("startMultiplayerGame", new java.lang.Integer (33));
    _methods.put ("getMultiplayerLobbyState", new java.lang.Integer (34));
    _methods.put ("sendMultiplayerGuess", new java.lang.Integer (35));
    _methods.put ("startMultiplayerNextRound", new java.lang.Integer (36));
    _methods.put ("getMatchHistory", new java.lang.Integer (37));
    _methods.put ("getMatchDetails", new java.lang.Integer (38));
    _methods.put ("getSinglePlayerMatchHistory", new java.lang.Integer (39));
    _methods.put ("getSinglePlayerMatchDetails", new java.lang.Integer (40));
    _methods.put ("playerReadyForFirstRound", new java.lang.Integer (41));
    _methods.put ("leaveMultiplayerGame", new java.lang.Integer (42));
  }
  ...
  //server
       ...
       case 24:  // GameModule/GameService/getGameSessionResult
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 25:  // GameModule/GameService/getGameState
       {
         String username = in.read_string ();
  ...
  // Explicit cleanup after game session ends
       case 26:  // GameModule/GameService/cleanupPlayerSession
       {
         String username = in.read_string ();
  ...
  // Admin word management
       case 27:  // GameModule/GameService/addWord
       {
       ...
       case 28:  // GameModule/GameService/updateWord
       {
       ...
       case 29:  // GameModule/GameService/deleteWord
       {
         String word = in.read_string ();
         GameModule.Bool $result = null;
       ...
       case 30:  // GameModule/GameService/getAllWords
       {
         String $result[] = null;
       ...
       case 31:  // GameModule/GameService/getSystemStatistics
       {
       ...
       case 32:  // GameModule/GameService/getLeaderboardEntries
       {
  ...
  // Multiplayer mode
       case 33:  // GameModule/GameService/startMultiplayerGame
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 34:  // GameModule/GameService/getMultiplayerLobbyState
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 35:  // GameModule/GameService/sendMultiplayerGuess
       {
         String username = in.read_string ();
         char letter = in.read_char ();
         GameModule.Bool $result = null;
       ...
       case 36:  // GameModule/GameService/startMultiplayerNextRound
       {
         String username = in.read_string ();
         GameModule.Bool $result = null;
  ...
  // Match history (returns JSON)
       case 37:  // GameModule/GameService/getMatchHistory
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 38:  // GameModule/GameService/getMatchDetails
       {
  ...
  // Single Player Match History
       case 39:  // GameModule/GameService/getSinglePlayerMatchHistory
       {
         String username = in.read_string ();
         String $result = null;
       ...
       case 40:  // GameModule/GameService/getSinglePlayerMatchDetails
       {
         String gameId = in.read_string ();
         String $result = null;
  ...
  // Client signals ready after match found dialog for 1v1 and multiplayer
       case 41:  // GameModule/GameService/playerReadyForFirstRound
       {
         String username = in.read_string ();
       ...
       case 42:  // GameModule/GameService/leaveMultiplayerGame
       {
         String username = in.read_string ();
